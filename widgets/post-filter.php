...
class Post_Filter extends \Elementor\Widget_Base {
    ...
    */
    public function get_title() {
        return __( 'Post Filter Bar', 'elementor-posts-filter' );
    }
    ...
    */
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => __( 'Content', 'elementor-posts-filter' ),
            ]
        );
        ...
        $this->add_control(
            'taxonomy',
            [
                'label' => __( 'Name of taxonomy to filter', 'elementor-posts-filter' ),
        ...
        $this->add_control(
            'post_id',
            [
                'label' => __( 'CSS ID of the post widget', 'elementor-posts-filter' ),
        ...
        $this->add_control(
            'order_by',
            [
                'label' => __( 'Order By', 'elementor-posts-filter' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'name',
                'options' => [
                    'name'  => __( 'Name', 'elementor-posts-filter' ),
                    'slug' => __( 'Slug', 'elementor-posts-filter' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'all_text',
            [
                'label' => __( 'Text to show for <b>Show All</b>', 'elementor-posts-filter' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => "all"
            ]
        );
        ...
        $this->start_controls_section(
            'section_style',
            [
                'label' => __( 'Style', 'elementor-posts-filter' ),
        ...
        $this->add_control(
            'color_filter',
            [
                'label' => __( 'Color', 'elementor-posts-filter' ),
        ...
        $this->add_control(
            'color_filter_active',
            [
                'label' => __( 'Active Color', 'elementor-posts-filter' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'filter_item_spacing',
            [
                'label' => __( 'Space Between', 'elementor-posts-filter' ),
        ...
        $this->add_control(
            'filter_spacing',
            [
                'label' => __( 'Spacing', 'elementor-posts-filter' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
    ...
    */
    protected function render() {
        ...
        '. __($settings['all_text'], 'elementor-posts-filter').'
        </li>';
